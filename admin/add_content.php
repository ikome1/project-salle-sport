...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="status" class="box" required>
         <option value="" selected disabled>-- selctionne le status</option>
      ...
      <p>liste de lecture<span>*</span></p>
      <select name="playlist" class="box" required>
         <option value="" disabled selected>--sélectionner la liste </option>
         <?php
      ...
      <p>sélectionner une vignette <span>*</span></p>
      <input type="file" name="thumb" accept="image/*" required class="box">
      <p>ajoutez une video ou une photo <span>*</span></p>
