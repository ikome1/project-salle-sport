...
<section class="playlists">
   ...
   <h1 class="heading">ajout de listes </h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">créer une nouvelle liste </h3>
         <a href="add_playlist.php" class="btn">ajout de listes</a>
      </div>
