...
<section class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data" class="login">
      ...
      <input type="password" name="pass" placeholder="entrez votre mot de passse" maxlength="20" required class="box">
      <p class="link">Vous n'avez pas de compte ? <a href="register.php">enregistrer un nouveau</a></p>
