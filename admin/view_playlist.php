...
<head>
   ...
   <title>Détails de la liste </title>
...
<section class="playlist-details">
   ...
   <h1 class="heading">détails de la liste</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">mettre à jour la liste</a>
...
<section class="contents">
   ...
   <h1 class="heading">liste de lecture de vidéos</h1>
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">regarder la vidéo</a>
      </div>
   <?php
         }
      }else{
