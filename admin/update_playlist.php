...
<head>
   ...
   <title>Mise à jour de la liste</title>
...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>statut de la liste <span>*</span></p>
      ...
      <p>vignette de la liste  <span>*</span></p>
      <div class="thumb">
      ...
      <div class="flex-btn">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">voir la liste</a>
      </div>
   </form>
   <?php
      } 
