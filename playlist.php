...
<section class="playlist">
   ...
   <h1 class="heading">detail de la liste</h1>
   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>sauvegardé</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>sauvegarder la liste </span></button>
            <?php
               }
            ?>
         </form>
...
<section class="videos-container">
   ...
   <h1 class="heading">liste de vidéos</h1>
