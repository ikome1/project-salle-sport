...
<section class="tutor-profile">
   ...
   <div class="details">
      ...
      <div class="flex">
         <p>total liste des lectrues : <span><?= $total_playlists; ?></span></p>
         <p>total videos : <span><?= $total_contents; ?></span></p>
         <p>total j'aime : <span><?= $total_likes; ?></span></p>
         <p>total commentaires: <span><?= $total_comments; ?></span></p>
      </div>
   </div>
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="playlist.php?get_id=<?= $course_id; ?>" class="inline-btn">voir la liste de lecture</a>
      </div>
      <?php
         }
      }else{
