...
<section class="liked-videos">
   ...
   <h1 class="heading"> j'aime videos</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">regarder</a>
   ...
   <?php
            ...
            echo "<p class="emtpy">le contenu n'a pas été trouvé !</p>";         
         }
      
    } else{
      echo "<p class="empty">Rien n'a encore été ajouté à la liste des j'aime !</p>";
   }
   ?>
