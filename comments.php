...
<section class="edit-comment">
   <h1 class="heading">ecrire un commentaire</h1>
   <form action="" method="post">
      ...
      <div class="flex">
         <a href="comments.php" class="inline-option-btn">annuler modifier</a>
...
<section class="comments">
   ...
   <h1 class="heading">vos commentaires</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         <div class="content"><span><?= $fetch_comment['date']; ?></span><p> - <?= $fetch_content['title']; ?> - </p><a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>">voir le contenu</a></div>
